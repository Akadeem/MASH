...
pyramid <- function(age.range,
  ...
  df_male <- data.frame(age_range = age.range, 
                        mortality = male.mortality, 
                        morbidity = male.morbidity)
  df_female <- data.frame(age_range = age.range, 
  ...
  ggplot() +
    ...
    coord_flip() +
    scale_fill_manual(values = c("Male.morbidity" = "#FFFFFF", "Male.mortality" = "#000000", "Female.morbidity" = "#FFFFFF", "Female.mortality" = "#7F7F7F")
                      ,
    ...
    theme(legend.position = legend.pos, legend.justification = legend.jus, legend.background = element_rect(fill = "white", color = "black"), legend.title = element_blank(), 
